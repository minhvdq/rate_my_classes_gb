        ...
        <div className='col-md-6 right-box'>
          <div className='row align-items-center'>
            <div className='header-text mb-4 mt-4'>
              <p className='h3 mb-0' style={{fontFamily: "Courier New, Courier, monospace", fontWeight: "600", textAlign: "center"}}>
                Welcome back!
              </p>
            </div>
            <div className="d-flex flex-row-reverse">
              <button type="button" onClick={togglePage} className="btn btn-link" style={{padding: "0"}}>
                Signup
              </button>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className='input-group mb-0 mt-2'>
                ...
                <button type="button" onClick={(e) => {e.preventDefault(); window.location.href = "http://localhost:3000/PasswordResetRequest/ui_assets/request.html"}} className="btn btn-link" style={{padding: "0"}}>
                  Forgot your password!
                </button>
                <div style={{height: "24px"}}>
                  <div className="text-danger me-2" style={{width:"12vw", fontSize: "0.9rem"}}>
                    {error}
                  </div>
                </div>
              </div>
